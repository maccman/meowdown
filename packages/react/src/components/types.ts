...
export interface EditorHandle {
  ...
  /**
   * Parses `markdown` and inserts it at the cursor as a single undoable
   * edit. An active selection collapses first and is never deleted — this is
   * a host-initiated insert (a template), not a paste. A lone paragraph is
